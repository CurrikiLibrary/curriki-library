...
require_once realpath(__DIR__ . '/../core/modules/search/classes/search.php');
global $search;
$search = new search();
$search->curriki_search_page_init();
$search->curriki_search_page_scripts();
// setting branding header
// $search->curriki_search_page_header();
$search->curriki_search_page_body();

// setting branding banner
