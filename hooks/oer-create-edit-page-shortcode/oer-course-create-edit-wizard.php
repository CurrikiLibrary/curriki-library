...
function oer_course_create_edit_wizard() {
    ob_start();
    global $wpdb;
    ...
    <style>
        .resource-content-section .row .col-md-4  p {
            padding: 10px;
        }
                                    ...
                                    //     if($current_user->user_login == "eprofessor"){
                                            ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <img src="<?php echo plugins_url('/core/oer/assets/images/loader2.gif', __DIR__);?>" id="file-loader-icon" style="display:none; width: 30px;height:30px" />
                                                    </div>
                                                </div>
