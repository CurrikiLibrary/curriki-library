<?php
class CurOerCourseCreateEditPageWidget extends \Elementor\Widget_Base {
    
    // ... other methods like get_title(), get_icon(), get_categories(), get_keywords()

    public function get_name() {
        return 'oer-course-create-edit-page-widget';
    }

    public function get_title() {
        return __('Curriki OER Course Create/Edit Page Widget', 'curriki-library');
    }
