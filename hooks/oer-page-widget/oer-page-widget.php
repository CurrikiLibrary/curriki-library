...
function oer_page_widget_before_render( $element ) {
    
    if (get_class($element) === 'CurOERPageWidget') {
        oer_page_init();
...
add_action( 'elementor/frontend/before_render', 'oer_page_widget_before_render' );
