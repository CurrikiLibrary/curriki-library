<?php
class CurOerPageResourcesWidget extends \Elementor\Widget_Base {
    
    // ... other methods like get_title(), get_icon(), get_categories(), get_keywords()

    public function get_name() {
        return 'oer-page-resources-widget';
    }

    public function get_title() {
        return __('Curriki OER Page Resources Widget', 'curriki-library');
    }
