...
<div class="text-center">
    <ul class="pagination2">
        <li class="page-item"><a class="page-link pagination-gray" href="<?php echo $firstURL; ?>"><i class="fa fa-angle-double-left"></i> </a></li>
        <li class="page-item"><a class="page-link pagination-gray" href="<?php echo $prevURL; ?>"><i class="fa fa-angle-left"></i> Back</a></li>
        <?php
        ...
        <li class="page-item"><a class="page-link pagination-gray" href="<?php echo $nextURL; ?>">Next <i class="fa fa-angle-right"></i></a></li>
        <li class="page-item"><a class="page-link pagination-gray" href="<?php echo $lastURL; ?>"> <i class="fa fa-angle-double-right"></i></a></li>
    </ul>
</div>