...
<div class="panel-item">
    <div class="panel-header">
        <span class="panel-btn <?php echo (($search->request['subject']) ? '' : 'collapsed'); ?>" data-toggle="collapse" data-target="#accordion-subject" aria-expanded="false" aria-controls="accordion-subject"><?php echo __('Subject','curriki'); ?></span> <i class="filter-icon fa fa-plus"></i>
    </div>
...
<div class="panel-item">
    <div class="panel-header">
        <span class="panel-btn <?php echo (($search->request['educationlevel']) ? '' : 'collapsed'); ?>" data-toggle="collapse" data-target="#accordion-education-level" aria-expanded="false" aria-controls="accordion-education-level"><?php echo __('Education Level','curriki'); ?> </span> <i class="filter-icon fa fa-plus"></i>
    </div>
...
<div class="panel-item">
    <div class="panel-header">
        <span class="panel-btn <?php echo ((($search->request['partner']) || ($search->request['reviewrating']) || ($search->request['memberrating'])) ? '' : 'collapsed'); ?>" data-toggle="collapse" data-target="#accordion-rating" aria-expanded="false" aria-controls="accordion-rating"><?php echo __('Rating','curriki'); ?> </span> <i class="filter-icon fa fa-plus"></i>
    </div>
...
<div class="panel-item">
    <div class="panel-header">
        <span class="panel-btn <?php echo (($search->request['instructiontype']) ? '' : 'collapsed'); ?>" data-toggle="collapse" data-target="#accordion-instructiontype" aria-expanded="false" aria-controls="accordion-instructiontype"><?php echo __('Type','curriki'); ?> </span> <i class="filter-icon fa fa-plus"></i>
    </div>
