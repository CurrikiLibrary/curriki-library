                    ...
                    <ul class="post-action">
                        ...
                        <?php 
                            if (isset($search->current_user->caps['administrator']) || (in_array("content_creator", $search->current_user->roles) && ($search->current_user->ID == $row['contributorid']))) {
                                $edit_link = get_bloginfo('url') . '/create-resource/?resourceid='. $row['id'];
                                if (isset($row['lp_object']) && !is_null($row['lp_object'])) {
                                    $edit_link = $edit_link = get_bloginfo('url') . '/create-resource-course/?resourceid='. $row['id'] . '&lp_object=' . $row['lp_object'] . '&lp_object_id=' . $row['lp_object_id'];
                                }
                        ?>
                            <li><a href="<?php echo $edit_link; ?>"><i class="fa fa-pencil"></i> Edit</a></li>
                        <?php } ?>
                    </ul>
                </div>
